...
public class PrincipalResponse {
    ...
    public class ProductosResp implements Parcelable {
        String producto_id;
        ...
        private ProductosResp(Parcel in) {
        ...
        public final Parcelable.Creator<PrincipalResponse.ProductosResp> CREATOR = new Parcelable.Creator<PrincipalResponse.ProductosResp>() {
            @Override
            public PrincipalResponse.ProductosResp createFromParcel(Parcel source) {
                return new PrincipalResponse.ProductosResp(source);
            }

            @Override
            public PrincipalResponse.ProductosResp[] newArray(int size) {
                return new PrincipalResponse.ProductosResp[size];
            }
        };
    }
}
