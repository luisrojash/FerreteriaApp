...
public class PagerGridLayoutManager extends RecyclerView.LayoutManager
    ...
    private void setPageIndex(int pageIndex, boolean isScrolling) {
        ...
        int ultimaPaginaSeleccionada=mLastPageIndex;
        ...
        if (pageIndex >= 0) {
            if (null != mPageListener) {
                mPageListener.onPageSelect(pageIndex,ultimaPaginaSeleccionada);
            }
        }
    }
    ...
    public interface PageListener {
         ...
         */
        void onPageSelect(int pageIndex,int pageLastIndex);
    }
}